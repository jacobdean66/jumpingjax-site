...
- **Publication Execution (D10 + H32/H34/H35)** — durable Execution request/result records, computed replay, read-only preflight diagnostics, and simulated planner visibility through H31 bridge; no execution controls.
