...
- **Publication Execution (D10 + H32/H34)** — durable Execution request/result records, computed replay, and read-only preflight diagnostics through H31 bridge; no execution controls.
