  ...
  return (
    <button
      ...
      className={compact
        ...
        : "inline-flex min-h-8 min-w-24 items-center justify-center rounded-xl border border-slate-200 bg-white px-2 py-2 text-center text-[11px] font-black leading-tight text-slate-700 hover:bg-slate-50"}
    >
      {label}
    </button>
  );
