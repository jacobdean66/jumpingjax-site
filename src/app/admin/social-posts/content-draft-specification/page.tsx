    ...
    <main className="sp-page">
      <section className="sp-container">
        <SocialPostsPageHeader
          title="Content Draft Specification Intelligence"
          description="Read-only non-publishable content specifications derived from Creative Brief Intelligence. This view does not generate final copy or media, and does not save, approve, schedule, publish, or execute content."
          query={query}
        />
