        ...
        <header className="flex flex-col gap-5 border-b border-slate-200 pb-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              href={
                query
                  ? `/admin/social-posts/seasonal-intelligence?${query}`
                  : "/admin/social-posts/seasonal-intelligence"
              }
              className="inline-flex min-h-10 items-center justify-center rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-black text-slate-950 hover:bg-slate-50"
            >
            ...
            <Link
              href={
                query
                  ? `/admin/social-posts/asset-intelligence?${query}`
                  : "/admin/social-posts/asset-intelligence"
              }
              className="inline-flex min-h-10 items-center justify-center rounded-full border border-slate-300 bg-white px-4 py-2 text-sm font-black text-slate-950 hover:bg-slate-50"
            >
              Asset intelligence
