    ...
    return {
      overview: {
        ...
        recordCounts: {
          ...
          repositoryReadOperations: replay.repositoryCompletenessSummary.availableReadOperations.length,
          repositoryMutationOperations: replay.repositoryCompletenessSummary.availableMutationOperations.length,
          repositoryVerificationIssues: replay.repositoryCompletenessSummary.verificationIssueCount,
          capabilityCoverageChecks: replay.repositoryCompletenessSummary.capabilityCoverage.satisfiedCount,
          readinessCoverageProviders: replay.repositoryCompletenessSummary.readinessCoverage.satisfiedCount,
          adapterCoverageChecks: replay.repositoryCompletenessSummary.adapterCoverage.satisfiedCount,
