    ...
    <main className="sp-page">
      <section className="sp-container">
        <SocialPostsPageHeader
          title="Draft Compliance Validator Intelligence"
          description="Read-only fixture-driven validation of explicit draft candidates against Wave 10 Content Draft Specifications. This view does not generate, save, approve, schedule, publish, or execute content."
          query={query}
        />
