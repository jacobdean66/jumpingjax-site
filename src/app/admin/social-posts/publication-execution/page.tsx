...
import {
  ...
  type SocialPlatformTiktokAdapterReplayDiagnostic,
...
import {
  ...
  type SocialPlatformLinkedinAdapterReplayDiagnostic,
        ...
        {diagnostics.length === 0 ? (
          ...
          <ul className="space-y-2">
            {diagnostics.map((diagnostic, index) => (
              ...
              >
                <span className="font-black uppercase tracking-wide text-slate-500">{diagnostic.severity}</span>
                {" · "}
