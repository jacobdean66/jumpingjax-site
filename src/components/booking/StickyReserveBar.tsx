...
export function StickyReserveBar({
  ...
  return (
    <div
      className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2 sm:px-6"
      role="region"
      aria-label="Reserve"
    >
      <div className="pointer-events-auto flex w-full max-w-4xl items-center gap-3 rounded-2xl border border-white/15 bg-[#071326]/92 px-3 py-3 shadow-[0_-12px_40px_rgba(0,0,0,0.45)] backdrop-blur-md sm:gap-4 sm:px-5 sm:py-4">
