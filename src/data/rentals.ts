 ...
 *
 * Fields:
 * - slug: URL segment under /rentals/[category]/[slug]; must match image basename (without extension).
 * - categoryId: One of CATEGORY_IDS; drives routing and asset folder under public/inflatables/assets/.
 * - title / shortDescription / description: Customer-facing copy (title should align with the image filename).
 * - startingPrice: Display “from” price in USD.
 * - dimensions: Setup footprint string shown on cards and detail.
 * - imageSrc: Path under public/ (served as static file). Convention: /inflatables/assets/[category]/[slug].jpg
 * - imageAlt: Accessible description of the unit in the photo.
 * - ageRecommendation / setupRequirements: Detail page bullets.
 *
 * Adding a rental: (1) Add the image file under public/inflatables/assets/[category]/[slug].jpg
 * (2) Append a RENTALS entry here with matching categoryId and slug.
 */
...
export const RENTALS: Rental[] = [
  {
    ...
    imageSrc: "/inflatables/assets/water-slides/18ft-tropical-splash.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/water-slides/dual-lane-racer-slide.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/water-slides/compact-splash-combo-slide.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/water-slides/hurricane-drop-water-slide.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/bounce-houses/castle-bounce-house.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/bounce-houses/princess-palace-bouncer.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/bounce-houses/sports-court-bounce.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/bounce-houses/superhero-city-bouncer.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/obstacle-courses/ninja-warrior-obstacle.jpg",
  ...
  },
  {
    ...
    imageSrc:
      "/inflatables/assets/obstacle-courses/boot-camp-challenge-course.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/combos/bounce-slide-wet-dry-combo.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/combos/toddler-combo-playland.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/event-packages/backyard-bash-package.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/event-packages/school-field-day-package.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/event-packages/church-festival-package.jpg",
  ...
  },
  {
    ...
    imageSrc: "/inflatables/assets/event-packages/block-party-triple.jpg",
