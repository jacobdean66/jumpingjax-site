...
export function createLocalAgentPreview(): AgentDashboard {
  ...
  return {demoMode:true,generatedAt:now.toISOString(),emergencyStop:false,maxConcurrency:1,agents,jobs,approvals:[],events,queue:{queued:0,claimed:0,running:0,stale:0,oldestActiveAt:null,watcherLastSeenAt:ago(2)}};
}
